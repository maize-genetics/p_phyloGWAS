...
find output/CDSMSAPerOG_HyPhy_20250203/ -name "*.fa" -type f| cut -d / -f 3|sed 's/.fa//g' |parallel -j 20 "grep -f data/annual_assemblies.txt output/CDSMSAPerOG_HyPhy_20250203/{}.fa|sed 's/>//g' > output/target_PAML_20250203/{}.target"
