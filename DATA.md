...
| DEG / abiotic-stress study metadata | `data/DEG_study_metadata.csv` | stage 11 | T1 |
...
| Rice → orthogroup mapping | `data/DEG_mappingFiles/` | 03B, 10A, 11 (`10B_candidateOGInvestigation.ipynb`) | T2 (regenerated by 10A) |
| Orthogroup → maize gene mapping | `data/OGToZm_mapping_v2.txt` | 03B, 05A, 08B, 09B, 11 (`10B_candidateOGInvestigation.ipynb`) | T2 (regenerated by 05A) |
...
| DeepGO GO annotation | `data/poaceaeHelixerOG_ancSeq_gapRemoved_v2_uppercase_output_CC_f.gmt` | 11 (`10B_candidateOGInvestigation.ipynb`) | T2 (regenerated via DeepGO) |
| Maize B73 v5 GO annotation | `data/Zm00001eb.1.fulldata_goList.txt` | 09B, 11 (`10B_candidateOGInvestigation.ipynb`) | T1 |
| Switchgrass GO table | `data/Pv_GOTable.txt` | 11 (GO enrichment) | T1 |
