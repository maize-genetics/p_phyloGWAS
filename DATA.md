...
| Rice → orthogroup mapping | `data/DEG_mappingFiles/` | 03B, 10A, 11 | T2 (regenerated by 10A) |
| Orthogroup → maize gene mapping | `data/OGToZm_mapping_v2.txt` | 03B, 05A, 08B, 09B, 11 | T2 (regenerated by 05A) |
...
| Maize B73 v5 GO annotation | `data/Zm00001eb.1.fulldata_goList.txt` | 09B, 11 | T1 |
