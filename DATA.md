...
| Rice → orthogroup mapping | `data/DEG_mappingFiles/` | 03D, 10A, 11 | T2 (regenerated by 10A) |
| Orthogroup → maize gene mapping | `data/OGToZm_mapping_v2.txt` | 03D, 08B, 09B, 11 | T2 (regenerated by 03C) |
| Per-OG miniprot GFF annotations | `output/orthofinderMiniProt/`, `output/orthofinderMiniProt_additionalOGs/` | 03E, 07Aa | T2 (regenerated via miniprot) |
